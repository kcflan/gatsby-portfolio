...
import { AppBar, Toolbar, Typography, Button, IconButton, Menu, MenuItem, CssBaseline } from '@material-ui/core/';
...
export default function Header({ siteTitle, scrollToContent }, ...props) {
	...
	let locationIsHome = typeof window !== 'undefined' && window.location.pathname === '/';
			...
			<AppBar position='fixed' className={classes.appbar}>
				...
				<Toolbar>
					...
					<div className={classes.sectionDesktop}>
						...
						{locationIsHome ? (
							<>
								<Button className={classes.btnLink} onClick={() => scrollToContent('section1')}>
									<span className='text-second'>Top</span>
								</Button>

								<Button className={classes.btnLink} onClick={() => scrollToContent('section2')}>
									<span className='text-second'>About</span>
								</Button>
								<Button className={classes.btnLink} onClick={() => scrollToContent('section3')}>
									<span className='text-second'>Projects</span>
								</Button>
								<Button className={classes.btnLink} onClick={() => scrollToContent('section4')}>
